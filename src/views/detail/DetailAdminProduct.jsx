...
import { createAdminOrder, createOrder, createRatingProduct } from "./http";
...
const DetailAdminProduct = ({ products, user }) => {
  ...
  const fetchProduct = async () => {
    const product = await fetchOneAdminProduct(slug, id);
  ...
  const handleSubmit = async () => {
    ...
    await createAdminOrder(id, params)
      .then(({ data }) => {
      ...
      <Container maxWidth="xl">
        ...
        <div className="lg:grid lg:grid-cols-2 flex flex-col justify-between detail-box mt-8 lg:px-32">
          ...
          <div className="character-box bg-white xl:pl-8 lg:pl-14 mb-6 lg:mt-0 mt-8">
            ...
            <div className="flex items-center justify-between md:ext-[32px] text-[24px] f-medium">
              {productDetail?.title_en}
              <Button
                className="!capitalize"
                size="large"
            ...
            <PhoneNumberInput
              ...
              className="mt-4 rounded-[4px] [&>input]:!border [&>input]:!border-1 [&>input]:!border-[#0000003b] [&>input]:hover:!border-[#000] [&>input]:!duration-200 [&>input:focus]:!border-[#feee00]"
              inputStyle={{
                height: "40px",
                fontSize: "16px",
                borderRadius: "4px",
...
export default connect(mapStateToProps, null)(DetailAdminProduct);
